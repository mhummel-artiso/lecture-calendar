...
export const addLecture = async (lecture: Lecture): Promise<Lecture> => {
    const response = await axiosInstance.post<Lecture>(lectureEndPointName(), lecture);
...
export const getLecture = async (lectureId: string): Promise<Lecture> => {
    const response = await axiosInstance.get<Lecture>(lectureEndPointName(lectureId))
    return Promise.resolve(response.data)
}

export const editLecture = async (lectureId: string, lecture: Lecture): Promise<Lecture> => {
    const response = await axiosInstance.put<Lecture>(lectureEndPointName(lectureId), lecture)
    return Promise.resolve(response.data)
}
