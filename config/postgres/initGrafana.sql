...
1	1	{\n\t"alertmanager_config": {\n\t\t"route": {\n\t\t\t"receiver": "grafana-default-email",\n\t\t\t"group_by": ["grafana_folder", "alertname"]\n\t\t},\n\t\t"receivers": [{\n\t\t\t"name": "grafana-default-email",\n\t\t\t"grafana_managed_receiver_configs": [{\n\t\t\t\t"uid": "",\n\t\t\t\t"name": "email receiver",\n\t\t\t\t"type": "email",\n\t\t\t\t"isDefault": true,\n\t\t\t\t"settings": {\n\t\t\t\t\t"addresses": "<example@email.com>"\n\t\t\t\t}\n\t\t\t}]\n\t\t}]\n\t}\n}\n	e0528a75784033ae7b15c40851d89484	v1	1693643959	t	1694682939
\.
...
authed-session:fba826ba9b329a191ae23ff5633be7b3	\\x7b	2592000	1694681122
...
2	1	1	prometheus	Prometheus	proxy	http://prometheus:9090				f			t	{"cacheLevel":"High","disableRecordingRules":false,"httpMethod":"POST","incrementalQueryOverlapWindow":"10m","manageAlerts":true,"prometheusType":"Prometheus"}	2023-09-02 10:39:20	2023-09-14 11:15:41	f	{}	t	PBFA97CFB590B2093
1	1	1	loki	Loki	proxy	http://loki:3100				f			f	{}	2023-09-02 10:39:20	2023-09-14 11:15:41	f	{}	t	P8E80F9AEF21F6940
3	1	1	grafana-mongodb-datasource	MongoDB	proxy					f			f	{"connection":"mongodb://mongodb:27017","user":"root"}	2023-09-02 10:39:20	2023-09-14 11:15:41	f	{"password":"I1pHUmtOREUxT1RNdE1UVXhPQzAwWWpnd0xUaGpaRFV0TldGbVlUTXlNVGN4WmpNMyMqWVdWekxXTm1ZZypVb1lXZUpIYRN2IZKo/SSGqR1uLJG9bHpwMr+40zSej63t1SuJZ8urwcJv7LA8orx8"}	f	P91231FF9AB6685FA
\.
...
1	1	Loki	datasource	I1pHUmtOREUxT1RNdE1UVXhPQzAwWWpnd0xUaGpaRFV0TldGbVlUTXlNVGN4WmpNMyMqWVdWekxXTm1ZZyplRXd3NWlxVlxp1k0Yi5Kf3nhxmIphheYpdw	2023-09-02 10:39:20	2023-09-14 11:15:41
2	1	Prometheus	datasource	I1pHUmtOREUxT1RNdE1UVXhPQzAwWWpnd0xUaGpaRFV0TldGbVlUTXlNVGN4WmpNMyMqWVdWekxXTm1ZZyp3aGNPQlY0aAg+PoVeFhmXEt7Q+A/A/gKhqA	2023-09-02 10:39:20	2023-09-14 11:15:41
3	1	MongoDB	datasource	I1pHUmtOREUxT1RNdE1UVXhPQzAwWWpnd0xUaGpaRFV0TldGbVlUTXlNVGN4WmpNMyMqWVdWekxXTm1ZZypiM1h3bXJjbd8vRXKLbItJLN6CYamfg6JYnMHfpRSsyisQW+ad0PV8UIwzM1+7GbIeIOPIjmHSNSZxSBunrbq6	2023-09-02 10:39:20	2023-09-14 11:15:41
\.
...
3	delete old login attempts	496	1694683541
\.
...
1	0	admin	admin@localhost		9f35e711bd8764a1c72d5e0f5dc6fd07c20b8438b8ad9d701820406666dbd623af1c9eebb56e9c5ce9414f2db83af31ec075	xK6jSTDhQv	Dv4t6b6iwF		1	t	f		2023-09-02 10:39:18	2023-09-02 10:39:18	1	2023-09-14 11:26:14	f	f
...
SELECT pg_catalog.setval('public.dashboard_version_id_seq', 27, true);
...
SELECT pg_catalog.setval('public.server_lock_id_seq', 19, true);
