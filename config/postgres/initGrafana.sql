...
1	1	{\n\t"alertmanager_config": {\n\t\t"route": {\n\t\t\t"receiver": "grafana-default-email",\n\t\t\t"group_by": ["grafana_folder", "alertname"]\n\t\t},\n\t\t"receivers": [{\n\t\t\t"name": "grafana-default-email",\n\t\t\t"grafana_managed_receiver_configs": [{\n\t\t\t\t"uid": "",\n\t\t\t\t"name": "email receiver",\n\t\t\t\t"type": "email",\n\t\t\t\t"isDefault": true,\n\t\t\t\t"settings": {\n\t\t\t\t\t"addresses": "<example@email.com>"\n\t\t\t\t}\n\t\t\t}]\n\t\t}]\n\t}\n}\n	e0528a75784033ae7b15c40851d89484	v1	1693643959	t	1693660202
\.
...
2	1	1	prometheus	Prometheus	proxy	http://prometheus:9090				f			t	{"cacheLevel":"High","disableRecordingRules":false,"httpMethod":"POST","incrementalQueryOverlapWindow":"10m","manageAlerts":true,"prometheusType":"Prometheus"}	2023-09-02 10:39:20	2023-09-02 15:10:03	f	{}	t	PBFA97CFB590B2093
1	1	1	loki	Loki	proxy	http://loki:3100				f			f	{}	2023-09-02 10:39:20	2023-09-02 15:10:03	f	{}	t	P8E80F9AEF21F6940
3	1	1	grafana-mongodb-datasource	MongoDB	proxy					f			f	{"connection":"mongodb://mongodb:27017","user":"root"}	2023-09-02 10:39:20	2023-09-02 15:10:03	f	{"password":"I1kyUTFOelUyTURndE5XTXdZUzAwTWpBNUxXRTRaall0WWpZd01HVmpZV1k0WVRoaCMqWVdWekxXTm1ZZypKSFNUVmU1MpyR08WUHGct3olNLQYfW1gI00hK4OEf20WAIZohEB/HcT3eaXOU/w5e"}	f	P91231FF9AB6685FA
\.
...
1	1	Loki	datasource	I1kyUTFOelUyTURndE5XTXdZUzAwTWpBNUxXRTRaall0WWpZd01HVmpZV1k0WVRoaCMqWVdWekxXTm1ZZypVMnBsZHU4NiXaQXaHVQWfcbRo5lBSrPIV2A	2023-09-02 10:39:20	2023-09-02 15:10:03
2	1	Prometheus	datasource	I1kyUTFOelUyTURndE5XTXdZUzAwTWpBNUxXRTRaall0WWpZd01HVmpZV1k0WVRoaCMqWVdWekxXTm1ZZyowUkFwTTVRT45USNf+sx7F7n0QKVNQIhGAKw	2023-09-02 10:39:20	2023-09-02 15:10:03
3	1	MongoDB	datasource	I1kyUTFOelUyTURndE5XTXdZUzAwTWpBNUxXRTRaall0WWpZd01HVmpZV1k0WVRoaCMqWVdWekxXTm1ZZypmT1BlTGVZV5H6lEXFwPhjcniCGyMgmMN6m8Sn96xAb/TVYFxf8aT6GQxKHi/As1SqF+dAZtSTxRJXK7fZ4yGq	2023-09-02 10:39:20	2023-09-02 15:10:03
\.
...
2	cleanup expired auth tokens	1	1693643960
3	delete old login attempts	2	1693660179
\.
...
1	0	admin	admin@localhost		9f35e711bd8764a1c72d5e0f5dc6fd07c20b8438b8ad9d701820406666dbd623af1c9eebb56e9c5ce9414f2db83af31ec075	xK6jSTDhQv	Dv4t6b6iwF		1	t	f		2023-09-02 10:39:18	2023-09-02 10:39:18	1	2023-09-02 15:15:45	f	f
\.
...
1	1	f839264f41f75932e92af94a07d954aa88431fe70655f1c471198ccea4483679	7f3fea5f1fbc0fe102b50d6274e0b96b0c5e2b9e01c20eed7dac0aa6e1589ead	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36	192.168.32.1	t	1693644590	1693644568	1693643964	1693643964	0
2	1	504a4430f97b3df1a65464d6a7369fb543d338643d3b42b98309904cc660c642	e3d89a25023b4d184f7737a6ce8175ed7f141e1d6b12af1606073cd8d806c77a	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36	192.168.32.1	t	1693660239	1693660239	1693659636	1693659636	0
\.
...
SELECT pg_catalog.setval('public.dashboard_version_id_seq', 12, true);
...
SELECT pg_catalog.setval('public.migration_log_id_seq', 488, true);
...
SELECT pg_catalog.setval('public.user_auth_token_id_seq', 2, true);
