...
1	1	{\n\t"alertmanager_config": {\n\t\t"route": {\n\t\t\t"receiver": "grafana-default-email",\n\t\t\t"group_by": ["grafana_folder", "alertname"]\n\t\t},\n\t\t"receivers": [{\n\t\t\t"name": "grafana-default-email",\n\t\t\t"grafana_managed_receiver_configs": [{\n\t\t\t\t"uid": "",\n\t\t\t\t"name": "email receiver",\n\t\t\t\t"type": "email",\n\t\t\t\t"isDefault": true,\n\t\t\t\t"settings": {\n\t\t\t\t\t"addresses": "<example@email.com>"\n\t\t\t\t}\n\t\t\t}]\n\t\t}]\n\t}\n}\n	e0528a75784033ae7b15c40851d89484	v1	1693643959	t	1694417663
\.
...
2	1	1	prometheus	Prometheus	proxy	http://prometheus:9090				f			t	{"cacheLevel":"High","disableRecordingRules":false,"httpMethod":"POST","incrementalQueryOverlapWindow":"10m","manageAlerts":true,"prometheusType":"Prometheus"}	2023-09-02 10:39:20	2023-09-11 09:34:25	f	{}	t	PBFA97CFB590B2093
1	1	1	loki	Loki	proxy	http://loki:3100				f			f	{}	2023-09-02 10:39:20	2023-09-11 09:34:25	f	{}	t	P8E80F9AEF21F6940
3	1	1	grafana-mongodb-datasource	MongoDB	proxy					f			f	{"connection":"mongodb://mongodb:27017","user":"root"}	2023-09-02 10:39:20	2023-09-11 09:34:25	f	{"password":"I1l6YzNNbU5sTTJZdE1EY3dNeTAwWVRjNUxXSXpNalF0TlRnMVpEWTNZVEpoTVRKayMqWVdWekxXTm1ZZyo5TzJDcDVDMB5z0lB1eu/M0PwEHjpKjjLThauUKHx2SL8Z1Es5MVYOc+Lry6ELtOy8"}	f	P91231FF9AB6685FA
\.
...
5	0	plugin.publickeys	last_updated	2023-09-02T16:02:27+02:00	2023-09-02 16:02:27	2023-09-02 16:02:27
6	0	infra.usagestats	anonymous_id	411858bc-bfda-48b8-8be7-8f359f446e64	2023-09-03 16:02:27	2023-09-03 16:02:27
7	0	infra.usagestats	last_sent	2023-09-11T08:52:46+02:00	2023-09-03 16:02:27	2023-09-11 08:52:46.125637
\.
...
1	1	Loki	datasource	I1l6YzNNbU5sTTJZdE1EY3dNeTAwWVRjNUxXSXpNalF0TlRnMVpEWTNZVEpoTVRKayMqWVdWekxXTm1ZZypxWFRHRzdQUgEahAQAd8y8HOLYTBsG6Vdmcw	2023-09-02 10:39:20	2023-09-11 09:34:25
2	1	Prometheus	datasource	I1l6YzNNbU5sTTJZdE1EY3dNeTAwWVRjNUxXSXpNalF0TlRnMVpEWTNZVEpoTVRKayMqWVdWekxXTm1ZZypZMm9oN1l2M+0KZ+r1YsVsR9iYilSXfnagJw	2023-09-02 10:39:20	2023-09-11 09:34:25
3	1	MongoDB	datasource	I1l6YzNNbU5sTTJZdE1EY3dNeTAwWVRjNUxXSXpNalF0TlRnMVpEWTNZVEpoTVRKayMqWVdWekxXTm1ZZyppa0txWndJarOzEnJ16AI0A3efWAdoUUjkmqkxhzNcxWE2VvfhjZDxOnz7vJ8Ae7LJRZ50k104JB+TxHHb/8kH	2023-09-02 10:39:20	2023-09-11 09:34:25
\.
...
2	cleanup expired auth tokens	14	1694415103
3	delete old login attempts	487	1694415978
\.
...
1	0	admin	admin@localhost		9f35e711bd8764a1c72d5e0f5dc6fd07c20b8438b8ad9d701820406666dbd623af1c9eebb56e9c5ce9414f2db83af31ec075	xK6jSTDhQv	Dv4t6b6iwF		1	t	f		2023-09-02 10:39:18	2023-09-02 10:39:18	1	2023-09-11 09:34:25	f	f
\.
...
3	1	2caf3db44c90c188c667bfb70f87ecf9355421eda6eba7a35849eeb8ed3dd505	b9fdec8c89dc9cdb3ba13ea4ef1a6316599f41348a5210973e40cd4a73f424d6	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36	172.21.0.1	t	1694417665	1694417665	1694415405	1694415405	0
\.
...
SELECT pg_catalog.setval('public.dashboard_version_id_seq', 13, true);
...
SELECT pg_catalog.setval('public.server_lock_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.user_auth_token_id_seq', 3, true);
