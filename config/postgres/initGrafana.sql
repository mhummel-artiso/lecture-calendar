...
1	1	{\n\t"alertmanager_config": {\n\t\t"route": {\n\t\t\t"receiver": "grafana-default-email",\n\t\t\t"group_by": ["grafana_folder", "alertname"]\n\t\t},\n\t\t"receivers": [{\n\t\t\t"name": "grafana-default-email",\n\t\t\t"grafana_managed_receiver_configs": [{\n\t\t\t\t"uid": "",\n\t\t\t\t"name": "email receiver",\n\t\t\t\t"type": "email",\n\t\t\t\t"isDefault": true,\n\t\t\t\t"settings": {\n\t\t\t\t\t"addresses": "<example@email.com>"\n\t\t\t\t}\n\t\t\t}]\n\t\t}]\n\t}\n}\n	e0528a75784033ae7b15c40851d89484	v1	1693643959	t	1693644020
\.
...
2	1	1	prometheus	Prometheus	proxy	http://prometheus:9090				f			t	{"cacheLevel":"High","disableRecordingRules":false,"httpMethod":"POST","incrementalQueryOverlapWindow":"10m","manageAlerts":true,"prometheusType":"Prometheus"}	2023-09-02 10:39:20	2023-09-02 10:39:20	f	{}	t	PBFA97CFB590B2093
1	1	1	loki	Loki	proxy	http://loki:3100				f			f	{}	2023-09-02 10:39:20	2023-09-02 10:39:20	f	{}	t	P8E80F9AEF21F6940
3	1	1	grafana-mongodb-datasource	MongoDB	proxy					f			f	{"connection":"mongodb://mongodb:27017","user":"root"}	2023-09-02 10:39:20	2023-09-02 10:39:20	f	{"password":"I1kyUTFOelUyTURndE5XTXdZUzAwTWpBNUxXRTRaall0WWpZd01HVmpZV1k0WVRoaCMqWVdWekxXTm1ZZypJZmdiM2R1ZpynwocgVGSd/2xLYAeh6dutwUjK0qu7A1+GmTnP1OhMc13OtkeLlELs"}	f	P91231FF9AB6685FA
\.
...
1	1	Loki	datasource	I1kyUTFOelUyTURndE5XTXdZUzAwTWpBNUxXRTRaall0WWpZd01HVmpZV1k0WVRoaCMqWVdWekxXTm1ZZypBWHd0MjJZQcOi9rJcnJq9rK3Y/JJardSR3g	2023-09-02 10:39:20	2023-09-02 10:39:20
3	1	MongoDB	datasource	I1kyUTFOelUyTURndE5XTXdZUzAwTWpBNUxXRTRaall0WWpZd01HVmpZV1k0WVRoaCMqWVdWekxXTm1ZZyo5b2kzcHFBWovL5YJf+ta5nTnvFD22+6jDp30/dOmZiN+1xiy6HGyKMem1/sBdIchxPhHAUruZqCVA9MYOtZgE	2023-09-02 10:39:20	2023-09-02 10:39:20
2	1	Prometheus	datasource	I1kyUTFOelUyTURndE5XTXdZUzAwTWpBNUxXRTRaall0WWpZd01HVmpZV1k0WVRoaCMqWVdWekxXTm1ZZypYZTJQQzV5Q3atTTiH45u4sI6C7SYtqULkpQ	2023-09-02 10:39:20	2023-09-02 10:39:20
\.
...
3	delete old login attempts	1	1693644560
\.
...
1	0	admin	admin@localhost		9f35e711bd8764a1c72d5e0f5dc6fd07c20b8438b8ad9d701820406666dbd623af1c9eebb56e9c5ce9414f2db83af31ec075	xK6jSTDhQv	Dv4t6b6iwF		1	t	f		2023-09-02 10:39:18	2023-09-02 10:39:18	1	2023-09-02 10:49:54	f	f
\.
...
SELECT pg_catalog.setval('public.dashboard_version_id_seq', 2, true);
